        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    foreach (var product in cart.Items)//trừ số lượng bên admin
                    {
                        var item = db.Products.FirstOrDefault(f => f.Id == product.ProductId);
                    ...
                    foreach(var sp in cart.Items)
                    {
                        ...
                        strSanPham += "<td>" + WebBanHang.Models.Common.Common.FormatNumber(sp.TotalPrice, 0) + "</td>";
                        strSanPham += "</tr>";
                    ...
                    WebBanHang.Models.Common.Common.SendMail("HaiShop", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                    ...
                    WebBanHang.Models.Common.Common.SendMail("HaiShop", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
